...
void LZWDictionary::addEntry(LZW::factor p_factor_id, std::string p_factor) {
...
std::pair<LZW::factor,std::string> LZWDictionary::getFactor(LZW::factor p_factor_id) {
...
std::pair<LZW::factor,std::string> LZWDictionary::getFactor(std::string p_factor) {
